...
exports.MicrofinanceService = void 0;
...
class MicrofinanceService {
     ...
     */
    async originateMicroLoan(borrowerId, amount, purpose, termMonths) {
        if (amount > 5000)
            throw new Error('Micro-loans capped at $5,000');
     ...
     */
    async computeAlternativeCreditScore(userId) {
     ...
     */
    async createSolidarityCircle(members, loanAmount) {
     ...
     */
    async liteKYCOnboarding(phoneNumber, nationalId) {
...
exports.MicrofinanceService = MicrofinanceService;
