...
exports.ConsciousnessBankingService = void 0;
class ConsciousnessBankingService {
    /**
     ...
     */
    getFinancialRightsMatrix(sentienceScore, consciousnessType) {
        const rights = {
     ...
     */
    async processDigitalUploadEconomicTransfer(upload) {
     ...
     */
    async createMentalAssetVault(entityId, assets) {
     ...
     */
    async getConsciousnessInsurance(entityId, sentienceScore, assetValueUSD) {
     ...
     */
    async createDigitalWill(entityId, consciousnessType, beneficiaries) {
    ...
    getMonetizationOptions(assetType) {
        const options = {
...
exports.ConsciousnessBankingService = ConsciousnessBankingService;
