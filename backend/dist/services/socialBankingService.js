...
exports.SocialBankingService = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class SocialBankingService {
    /**
     * Feature 21.1: Create a peer-to-peer group savings pot
     */
    async createGroupPot(name, goal, creatorId) {
     ...
     */
    async inviteMember(potId, inviteeId) {
     ...
     */
    async contribute(potId, userId, amount) {
     ...
     */
    async getUserFinancialXP(userId) {
