...
exports.CryptographicProtocolsService = void 0;
const crypto = __importStar(require("crypto"));
class CryptographicProtocolsService {
    /**
     ...
     */
    async generateKyberKeyPair(level, hsmLevel) {
     ...
     */
    async signWithDilithium(message, hsmKeyRef, level = 'DILITHIUM_3') {
     ...
     */
    async signWithSPHINCS(message, variant = 'SPHINCS_SHA256_128F') {
     ...
     */
    async negotiateHybridTLSSession(clientPublicX25519, clientPublicKyber768) {
     ...
     */
    deriveTransactionKey(masterSecret, transactionId, purpose) {
     ...
     */
    getPasswordHashingConfig(useCase) {
        const configs = {
            NEW_USER: {
                algorithm: 'Argon2id',
     ...
     */
    async initiateZKPPChallenge(userId) {
     ...
     */
    async initiateTSSWalletRecovery(walletAddress, requesterIds, threshold = 2, totalShares = 3) {
     ...
     */
    async executoCryptoShredding(userId, dataCategories, reason) {
     ...
     */
    async rotateSecret(secretId, rotationPolicy) {
     ...
     */
    async generateCryptographicRandomness(use) {
...
exports.CryptographicProtocolsService = CryptographicProtocolsService;
