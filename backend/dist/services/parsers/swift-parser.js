...
exports.parseSWIFTMT103 = parseSWIFTMT103;
exports.parseSWIFTMT202 = parseSWIFTMT202;
 ...
 */
function parseSWIFTMT103(rawMessage, tenantId) {
    const fields = extractSWIFTFields(rawMessage);
    // :20: Transaction Reference
    const reference = fields['20'] || (0, uuid_1.v4)();
 ...
 */
function parseSWIFTMT202(rawMessage, tenantId) {
    const fields = extractSWIFTFields(rawMessage);
    const reference = fields['20'] || (0, uuid_1.v4)();
...
// ─── Helper Functions ─────────────────────────────────────────────────
function extractSWIFTFields(message) {
    const fields = {};
...
function parsePartyField(field) {
 ...
 */
function parseSWIFTMessage(rawMessage, tenantId) {
