...
exports.FHEComputeService = void 0;
...
class FHEComputeService {
     ...
     */
    async compareEncryptedBalances(userId, thresholdAmount) {
     ...
     */
    async aggregateSalariesFHE(encryptedSalaries) {
        ...
        const simulatedCipherSum = Buffer.from(`fhe-sum:${encryptedSalaries.length}-encrypted-values`).toString('base64');
     ...
     */
    async computeCreditScoreFHE(encryptedInputs) {
     ...
     */
    async computePortfolioRiskFHE(encryptedWeights, encryptedCovMatrix) {
     ...
     */
    async runFHEFraudDetection(encryptedFeatures) {
...
exports.FHEComputeService = FHEComputeService;
