...
exports.ErrorCodeService = exports.ERROR_REGISTRY = void 0;
const ALL_ERRORS = [
    // AUTH
...
exports.ERROR_REGISTRY = new Map(ALL_ERRORS.map(e => [e.code, e]));
class ErrorCodeService {
    resolve(code) {
        return exports.ERROR_REGISTRY.get(code);
    }
    buildErrorResponse(code, requestId, meta) {
    ...
    get totalCount() { return exports.ERROR_REGISTRY.size; }
}
