...
exports.TaxOptimizationService = void 0;
...
class TaxOptimizationService {
     ...
     */
    async calculateCapitalGains(events) {
        let shortTermGains = new decimal_js_1.default(0);
        let longTermGains = new decimal_js_1.default(0);
        for (const e of events) {
            const gl = new decimal_js_1.default(e.gainLoss);
            if (e.isLongTerm) {
     ...
     */
    async getCurrentTaxBracket(annualIncome) {
     ...
     */
    async findHarvestingOpportunities(userId) {
     ...
     */
    async getMultiJurisdictionSummary(userId) {
        return [
...
exports.TaxOptimizationService = TaxOptimizationService;
