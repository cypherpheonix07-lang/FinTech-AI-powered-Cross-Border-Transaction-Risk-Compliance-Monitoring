...
exports.PlanetaryScaleFinanceService = void 0;
class PlanetaryScaleFinanceService {
    /**
    ...
    async calculatePlanetaryResourceDividend(params) {
        ...
        return {
            ...
            distribution: Object.fromEntries(Object.entries(distributionModel).map(([k, v]) => [k, parseFloat((dividendUSD * v).toFixed(2))])),
     ...
     */
    async runCosmicComplianceCheck(entityId, operationType, jurisdiction) {
        const treatyMap = {
...
exports.PlanetaryScaleFinanceService = PlanetaryScaleFinanceService;
