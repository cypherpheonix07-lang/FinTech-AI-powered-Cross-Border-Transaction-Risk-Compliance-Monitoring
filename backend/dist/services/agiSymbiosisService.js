...
exports.AGISymbiosisService = void 0;
class AGISymbiosisService {
    /**
     ...
     */
    async runAutonomousYieldFarm(agent, availableCapitalUSD, protocolWhitelist) {
        // Verify fiduciary constraints
        const maxExposure = agent.fiduciaryConstraints
            .find(c => c.type === 'RISK_EXPOSURE_CAP')?.value ?? 0.25;
     ...
     */
    async distributeAILaborWages(totalRevenueUSD, contributors) {
     ...
     */
    async listComputeOffers(resourceType) {
        const spotPricePerHour = {
            GPU_A100: 2.10,
            GPU_H100: 4.25,
            TPU_V4: 3.80,
     ...
     */
    async updateMachineReputation(agentId, event) {
...
exports.AGISymbiosisService = AGISymbiosisService;
