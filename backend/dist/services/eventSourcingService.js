...
class EventSourcingService {
    eventStore = []; // In production: EventStoreDB or Axon Server
    /**
     ...
     */
    async replayAggregate(aggregateId) {
     ...
     */
    async getStateAtTime(aggregateId, asOfDate) {
        const events = this.eventStore
     ...
     */
    async queryReadModel(aggregateId) {
