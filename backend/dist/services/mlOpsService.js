...
class MLOpsService {
     ...
     */
    async registerModel(name, type, config) {
     ...
     */
    async triggerRetraining(modelId) {
...
exports.MLOpsService = MLOpsService;
