...
export class ZeroTrustService {
   ...
   */
  async logContinuousVerification(sessionId: string, type: string, status: 'SUCCESS' | 'FAILED', data: any) {
   ...
   */
  async verifyLiveness(sessionId: string, proof: any): Promise<boolean> {
