...
export const CBDC_COMMANDS: CommandItem[] = [
  ...
  { id: 'cbdc-tax', name: 'CBDC Tax Reporting', category: 'Finance', icon: FileChart, path: '/cbdc-tax', description: 'Generate tax reports for CBDC activity' },
...
export const QUANTUM_COMMANDS: CommandItem[] = [
  ...
  { id: 'quantum-upgrade', name: 'Security Upgrade Path', category: 'Security', icon: CheckBadge, path: '/quantum-upgrade', description: 'Roadmap for quantum security upgrades' },
...
export const HOLOGRAPHIC_COMMANDS: CommandItem[] = [
  ...
  { id: 'holo-budget', name: 'Holo Budget', category: 'Visualization', icon: Cube, path: '/holo-budget', description: 'Budget display in hologram' },
  { id: 'holo-timeline', name: 'Transaction Timeline', category: 'Visualization', icon: Timeline, path: '/holo-timeline', description: 'Holographic transaction timeline' },
