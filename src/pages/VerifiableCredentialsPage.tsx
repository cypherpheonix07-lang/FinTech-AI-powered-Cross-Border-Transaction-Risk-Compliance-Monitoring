  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm lg:col-span-2">
           <div className="flex items-center justify-between mb-6">
              ...
              <div className="relative">
                 ...
                 <input 
                    type="text" 
                    placeholder="Search User/DID..." 
                    className="pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                 />
              </div>
           </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 overflow-hidden flex flex-col relative">
           <div className="mb-6">
              <h3 className="font-bold text-slate-900">Selective Disclosure Lab</h3>
              <p className="text-xs text-slate-500 mt-1">Simulate ZK-Proof generation for identity requests.</p>
           </div>
           ...
           <div className="space-y-4 flex-1">
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                 ...
                 <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-slate-800">Age Verification (18+)</span>
                 </div>
              </div>
              ...
              <div className="p-4 bg-emerald-50/50 rounded-xl border border-emerald-100 border-dashed">
                 ...
                 <div className="font-mono text-[10px] text-emerald-800 break-all bg-white p-2 rounded-lg border border-emerald-100 shadow-inner">
                    { '{ "type": "zk-snark", "schema": "age-greater-than", "value": true, "revealed": "none", "hash": "0x992fa...881c" }' }
                 </div>
              </div>
           </div>

           <button className="w-full mt-6 py-3 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition shadow-lg shadow-emerald-600/20 active:scale-95 duration-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl relative overflow-hidden group">
             ...
             <button className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-500 transition-all text-sm group-hover:gap-3">
         ...
         <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
            <div>
               <div className="flex items-center gap-3 mb-6 text-slate-800">
                  ...
                  <h3 className="font-bold text-lg tracking-tight">Revocation Registry</h3>
               </div>
            ...
            <div className="flex items-center justify-between p-4 bg-rose-50 rounded-xl border border-rose-100">
               <div className="text-xs font-bold text-rose-700">Accumulator Size: 1,402 Revocations</div>
               <button className="text-[10px] font-bold text-rose-600 hover:text-rose-800 underline uppercase tracking-widest">Update Merkle Root</button>
            </div>
         </div>
      </div>
